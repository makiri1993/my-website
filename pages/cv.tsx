...
import TimelineContainer, { TimelineElementData, TimelineElementPosition, Icon } from '@/components/Timeline/TimelineContainer'

@Component
export default class CV extends Vue {
  private timelineElements: TimelineElementData[] = [
    {
      id: 1,
  ...
  render() {
    return <TimelineContainer timelineElements={this.timelineElements} />
  }
}
